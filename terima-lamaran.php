...
<body>
    ...
    <h1 class="display-4 text-center">Sedang Mencoba Menerima Lamaran</h1>
...
mysqli_query($db,"UPDATE lamaran SET status = 'Diterima' where id = $idLamaran");
if (mysqli_affected_rows($db) == 1){
  echo "
    <script>
      Swal.fire('Data Lamaran Diterima','','success').then(function(){
        window.location = 'data-pelamar.php';
      });
    </script>
  ";
